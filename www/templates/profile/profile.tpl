		...
		<div class="row offset-md-1">
			...
			<div class="col">
				<div class="user-info">
					...
					<div class="user-info__desc"><?=$currentUser->name?> <?=$currentUser->surname?></div>
				</div>
				<div class="user-info">
					...
					<div class="user-comment">
						<div class="user-comment-wrap">
							<div class="comment-wrap">
								...
								<div class="user-date"><i class="far fa-clock"></i><span class="user-date--dat">15 Мая 2017 года в 10:02</span></div>
							</div>
							<p class="user-text">Замечательный парк, обязательно отправлюсь туда этим летом.</p>
						</div>
					</div>
					<div class="user-comment">
						<div class="user-comment-wrap">
							<div class="comment-wrap">
								...
								<div class="user-date"><i class="far fa-clock"></i><span class="user-date--dat">12 Мая 2017 года в 20:39</span></div>
							</div>
							<p class="user-text">Замечательный парк, обязательно отправлюсь туда этим летом.</p>
						</div>
					</div>
