<div class="container">
		<div class="row">
			<div class="col-xl-10 offset-1">
				...
				<form enctype="multipart/form-data" action="<?=HOST?>blog/category-delete?id=<?=$cat['id']?>" method="POST" class="form mb-100 pb-20 pt-35">
					<div class="fieldset">
						<label>
					...
					<div class="row">
						<div class="col-md-auto pr-10">
							<input type="submit" name="catDelete" class="button button--del button--tp-0" value="Удалить" />
						</div>
