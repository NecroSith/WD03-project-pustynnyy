<div class="header-admin">
		...
		<div class="header-admin-nav">
			...
			<div class="header-admin-nav__items">
				<i class="fa fa-folder header-admin-nav__icons"></i>
			...
			<div class="header-admin-nav__items"><i class="fa fa-envelope header-admin-nav__icons"></i><a class="header-admin-nav__link" href="<?=HOST?>messages">Сообщения</a></div>
		</div>
