...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Авг 03 2018 г., 22:20
...
(4, 'Ян Пустынный', '<p>Всем привет, меня зовут Ян. Я - веб-разработчик из Архангельска. Занимаюсь фронтенд разработкой. Опыт пока не очень большой, но я считаю, что делаю большие успехи. И на этом сайте я выкладываю свои работы и веду небольшой блог обо всем на свете.</p>\r\n', '955782362.jpg');
...
(3, 'июль 2018 - по настоящее время', 'Фронтенд разработчик, RunwaySale', 'Верстка дизайна сайта портала торговой сети RunwaySale по psd макетам. Внедрение дизайна в продакшен. Использование jqery и knockout.js для создания интерактива. ');
